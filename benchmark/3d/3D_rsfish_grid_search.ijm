////////// 3D grid search for RS-FISH benchmark //////////

// Input images path
dir = "ufish/data_3d/train/image-uint8/";

// Output csv path
csv = "ufish/benchmarks/3d/RS/results/"
...
intenThr_vals = newArray(0,10,50,100,150,200,255); // 7 steps //(0,255)
...
blockSizZ = 4;							// multithread param
///////////////////////////////////////////////////

// Location of file with all the run times that will be saved:
timeFile = "ufish/benchmarks/3d/RS/grid_search_exeTime.txt";
